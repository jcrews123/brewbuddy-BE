...
from src.models import db, User, Beer, Brewery, FavoriteBeers, FavoriteUsers, FavoriteBreweries, PointTransaction, UserImage, BreweryReview, BeerReview, Journey, Route, UserRewards
